...
PHyperProp propertyOncePlusOperator() {
...
TEST(PropertyLibTest, ValidTraceOncePlusOperator_Simple) {
...
TEST(PropertyLibTest, ValidTraceOncePlusOperator) {
  PHyperProp property = propertyOncePlusOperator();
...
TEST(PropertyLibTest, InvalidTraceOncePlusOperator) {
  PHyperProp property = propertyOncePlusOperator();
...
TEST(PropertyLibTest, ValidTraceOperator_XPlus_FPlus) {
  PVarMap varmap = std::make_shared<VarMap>();
  unsigned xid = varmap->addIntVar("x");
...
TEST(PropertyLibTest, InvalidTraceOperator_XPlus_FPlus) {
   PVarMap varmap = std::make_shared<VarMap>();
  unsigned xid = varmap->addIntVar("x");
  unsigned yid = varmap->addIntVar("y");
  std::string formula = "(F+ (IMPLIES (EQ x) (X+ (EQ y))))";

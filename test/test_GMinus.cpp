...
PHyperProp property1AlwaysMinusOperator() {
...
PHyperProp property2AlwaysMinusOperator() {
  PVarMap varmap = std::make_shared<VarMap>();
  varmap->addIntVar("x");
  varmap->addIntVar("y");
...
TEST(PropertyLibTest, ValidTraceAlwaysMinusOperator_Test1) {
  PHyperProp property = property1AlwaysMinusOperator();
...
TEST(PropertyLibTest, InvalidTraceAlwaysMinusOperator_Test1) {
  PHyperProp property = property1AlwaysMinusOperator();
...
TEST(PropertyLibTest, ValidTraceAlwaysMinusOperator_Test2) {
  // (G (Or (eqX, eqY)))
  PHyperProp property = property2AlwaysMinusOperator();
...
TEST(PropertyLibTest, InvalidTraceAlwaysMinusOperator_Test2) {
  // (G (Or (eqX, eqY)))
  PHyperProp property = property2AlwaysMinusOperator();
